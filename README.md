...
## Необходимые пакеты для работы Gitlab Runner

Если возникла необходимость в автоматизированной загрузке артефактов через Gitlab Runner, необходимо установить следующие пакеты:
...
* android-sdk
* flutter (через snap или вручную)
